...
import ErrorField from './components/form-field/error-label';
...
export default class RegisterPage extends React.Component {
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmitForm} title="Register form">
        <FormField
          labelText="Name"
          name="name"
          id="name"
        ...
        <Field label="Genre">
          ...
          <ErrorField error={formErrors.genre} show={!!formErrors.genre} />
        </Field>
